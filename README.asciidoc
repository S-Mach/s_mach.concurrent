...
* +Future.sideEffect+ - compose a Future and a side effect into a new Future that completes successfully after both
the original Future and the side effect finish. Fails if either the original Future or the side effect fail.
