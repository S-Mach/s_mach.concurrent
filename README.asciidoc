...
* Are a grown up async coder and tired (so tired) of being punished for waiting on Futures with unnecessary ritual cruft
(Await.result ... very common in testing code!)
...
async.using(myAsyncConfig).run("1","2","3")
