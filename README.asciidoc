...
* +Future.sideEffect+ - do something after a Future completes. Completes successfully after both original Future and
side effect finish. Fails if either original Future or sideEffect fail.
