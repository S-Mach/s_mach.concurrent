...
+s_mach.concurrent+ provides the +workers+ method for controlling the number of concurrent operations, specified as the
first parameter to the +workers+ method.
