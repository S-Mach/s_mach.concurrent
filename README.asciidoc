...
+s_mach.concurrent+ also provides the +workers+ method for controlling the amount of concurrency. The number of
concurrent workers is specified as the first parameter.
